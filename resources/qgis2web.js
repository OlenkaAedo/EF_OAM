...
map.getView().fit([-8230878.466269, -1574509.727829, -8118344.528576, -1505451.802215], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DISTRITOS DE LA PROVINCIA DE ANDAHUAYLAS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (81 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapa Elaborado por Olenka Aedo Mejia para el curso de Cartografía - Ciclo 2025-II';
            }
